...
namespace Tebak_Kata
{
    class Program
    {
        ...
        static String kataMisteri = "MANCHESTER UNITED";
        ...
        static void Intro()
        {
            ...
            Console.WriteLine("Petunjuk 1 topik : sepak bola ");
            Console.WriteLine("Petunjuk 2       : 2 kata lucu");
            Console.WriteLine($"Kata tersebut terdiri dari {kataMisteri.Length} huruf");
            Console.WriteLine("Klub apakah yang dimaksud?");
            Console.WriteLine("");
            Console.WriteLine("Enter untuk mulai menebak");
            Console.ReadKey();
            Console.WriteLine();
        }
        ...
        static void EndGame()
        {
            ...
            Console.WriteLine("XiXiXiXiXiXi Lucu Bangett");
            Console.ReadLine();
        }
    }
}